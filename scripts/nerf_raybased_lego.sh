...
CUDA_VISIBLE_DEVICES=2 nohup python run_nerf_raybased.py --model_name nerf_v6 --config configs/lego_noview.txt --n_sample_per_ray 16 --netwidth 256 --netdepth 11 --datadir_kd data/nerf_synthetic/lego:data/nerf_synthetic/lego_v13_16x16patchesv3_10kimages_splitsize32 --data_mode 16x16patches_v3 --n_pose_video 50,4,1 --N_iters 1200000 --N_rand 24 --use_residual --project nerfv6__lego__S16W256D11_DPRGB_Res_NoDir__Datav13_BS786*16*16 --cache_ignore data --screen --num_workers 4 --i_update_data 10000 > /dev/null &