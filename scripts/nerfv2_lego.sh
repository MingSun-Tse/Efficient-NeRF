...
CUDA_VISIBLE_DEVICES=1 python run_nerf_raybased.py --model_name nerf_v3.4.2 --config configs/lego_noview.txt --n_sample_per_ray 16 --netwidth 1024 --netdepth 11 --datadir_kd data/nerf_synthetic/lego:data/nerf_synthetic/lego_v11_3x3rays_queue --n_pose_video 20,1,1 --N_iters 1200000 --N_rand 1024 --data_mode rays --use_residual --scale 3 --project nerfv3.4.2__lego__S16W1024D11_KDDataV11_Res --cache_ignore data --screen --i_testset 10000000 --N_rand 12 --num_workers 16 --dim_dir 27 --dim_rgb 27 --debug
