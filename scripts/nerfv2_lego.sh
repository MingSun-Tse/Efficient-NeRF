...
# Test: nerf
CUDA_VISIBLE_DEVICES=0 python run_nerf_v2.py --config configs/lego.txt --model_name nerf --pretrained_ckpt Experiments/nerf__lego_SERVER-20210613-195444/blender_paper_lego/200000.tar --render_only --n_pose_video 10 --debug


# Test: nerf_v2
CUDA_VISIBLE_DEVICES=1 python run_nerf_v2.py --config configs/lego.txt --render_only --n_sample_per_ray 4 --netwidth 1024 --netdepth 32 --skips 8,16,24 --directly_predict_rgb --n_pose_video 40 --video_poses_perturb --pretrained_ckpt Experiments/*-213124/weights/400000.tar --debug
