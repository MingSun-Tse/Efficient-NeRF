...
CUDA_VISIBLE_DEVICES=4 python run_nerf_raybased.py --model_name nerf_v3.2 --config configs/donerf_forest_noview.txt --n_sample_per_ray 16 --netwidth 181 --netdepth 88 --datadir_kd data/donerf_data/forest_v8_Rand_Origins_Dirs_4096RaysPerNpy_10kImages --n_pose_video 20,1,1 --N_iters 1200000 --N_rand 20 --data_mode rays --hard_ratio 0.2 --hard_mul 20 --use_residual --project nerfv3.2__donerf_forest__S16W181D88_DPRGB_Res_NoDir_ResMLPBody__DataV8_BS98304_Hard0.2_20xBS__WarmupLR --cache_ignore data --screen --trial.ON --trial.body_arch resmlp --num_worker 8 --i_update_data 10000 --warmup_lr 0.0001,200 --given_render_path_rays data/donerf_data/forest/test_rays.pt --testskip 1 --i_video 1000000000000 --trial.near 5.79003734588623 --trial.far 1293.1921508789062
