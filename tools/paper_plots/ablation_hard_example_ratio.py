...
args.mode = 'test'
args.exp_mark = 'SERVER005-20211110-120614,SERVER-20211111-011851,SERVER-20211112-094904,SERVER-20211111-011910'
colors = ['k', 'g', 'b', 'r']
labels = ['r=0', 'r=0.1', 'r=0.2', 'r=0.3']
xunit = 1000
...
xlabel_fs = 14
ylabel_fs = 14
savename = f'ablation_hard_example_ratio.pdf'
# *********************************************************************
