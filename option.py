...
parser.add_argument('--no_rand_focal', dest='use_rand_focal', action='store_false',
                    default=True, help='use random focal when creating data')
...
parser.add_argument('--select_pixel_mode', type=str,
...
parser.add_argument('--body_arch', type=str, default='conv',
...
parser.add_argument('--act', type=str, default='relu',
                    choices=['relu', 'lrelu'], help='main activation func in a network')
parser.add_argument('--warmup_lr', type=str, default='')
parser.add_argument('--lpips_net', type=str, default='alex')
parser.add_argument('--pseudo_data_hold_ratio', type=float, default=0,
                    help='hold a part of pseudo data, not used for training, to control sample size')
parser.add_argument('--given_render_path_rays', type=str, default='')
parser.add_argument('--learn_depth', type=str, default='',
...
parser.add_argument('--trial.body_arch', type=str,
                    default='mlp', choices=['mlp', 'resmlp'])
parser.add_argument('--trial.res_scale', type=float, default=1.)
parser.add_argument('--trial.n_learnable', type=int,
                    default=2, help='num of learnable layers')
parser.add_argument('--trial.inact', default='relu', choices=[
                    'none', 'relu', 'lrelu'], help='the within activation func in a block')
parser.add_argument('--trial.outact', default='none', choices=[
                    'none', 'relu', 'lrelu'], help='the output activation func in a block')
parser.add_argument('--trial.n_block', type=int, default=-
                    1, help='num of block in network body')
